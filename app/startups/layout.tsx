...
const sidebarItems = [
  ...
  { id: 'startup', label: 'My Startups', icon: Building2, href: '/dashboard' },
  { id: 'jobs', label: 'Job Board', icon: Briefcase, href: '/dashboard' },
  { id: 'resume', label: 'My Resume', icon: FileText, href: '/dashboard' },
  { id: 'resources', label: 'Resources', icon: BookOpen, href: '/dashboard' },
  { id: 'investors', label: 'Investors', icon: Users, href: '/dashboard' },
];
          ...
          <ul className="space-y-2">
            {sidebarItems.map((item) => {
              ...
              return (
                <li key={item.id}>
                  <button
                    onClick={() => handleNavigation(item.href, item.id === 'overview' ? undefined : item.id)}
            ...
            <li>
              <button
                ...
                className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors bg-blue-100 text-blue-700"
              >
