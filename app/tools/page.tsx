  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth >= 768) {
        ...
        setVisibleCategories(expandedCategories ? categories : categories.slice(0, 3));
      }
    };
        ...
        <div className="mb-8">
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="md:hidden flex items-center space-x-1 px-3 py-2 rounded-lg text-sm font-medium text-blue-600 hover:bg-blue-50"
            >
              {expandedCategories ? (
                <>
                  <span>Show Less</span>
