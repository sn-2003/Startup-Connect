...
const newsData = [
  ...
  },
  {
    ...
    source: "VentureLink Editorial",
    url: "https://venturelink.com/2024/01/15/top-pitch-decks-analysis",
    publishedAt: new Date('2024-01-14T12:00:00Z'),
    category: 'STARTUP' as const,
    readTime: "7 min read",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&h=200&fit=crop",
    author: "VentureLink Team",
  ...
  },
  {
    ...
    source: "VentureLink Editorial",
    url: "https://venturelink.com/2024/01/13/founder-spotlight-1m-users",
