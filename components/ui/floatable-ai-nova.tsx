...
export default function FloatableAiNova() {
  ...
  return (
    <>
      ...
      {!open && (
        <button
          className="fixed bottom-24 right-6 z-50 bg-blue-600 hover:bg-blue-700 text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-110 flex items-center space-x-2 md:bottom-6"
