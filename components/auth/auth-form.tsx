...
export default function AuthForm() {
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // 2. Add user to Brevo (non-blocking)
      const addToBrevo = async () => {
        try {
          console.log('Attempting to add to Brevo:', { email, name });
          
          // Use relative URL to hit our API route
      ...
      // Don't await Brevo call to prevent blocking the user
      addToBrevo();
