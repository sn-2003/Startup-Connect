        ...
        <div className="lg:hidden overflow-x-auto pb-4 -mx-4 px-4">
          <div className="flex space-x-4 w-max">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="w-72 flex-shrink-0 bg-white border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="lg:hidden overflow-x-auto pb-4 -mx-4 px-4">
            <div className="flex space-x-4 w-max">
              {filteredNews.map((item) => (
                <article key={item.id} className="w-72 flex-shrink-0 bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-200">
                  {item.image && (
                    <div className="relative h-40 overflow-hidden">
                      ...
                      <div className="absolute top-2 left-2">
                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${getCategoryColor(item.category)}`}>
                          {item.category}
                        </span>
                      </div>
                  ...
                  <div className="p-4">
                    ...
                    <a
                      ...
                      className="text-blue-600 hover:text-blue-700 flex items-center space-x-1 font-medium text-xs"
                    >
                      <span>Read More</span>
